...
- مجوز تماس در سمت سرور و به‌صورت `fail closed` اعمال می‌شود؛ خروجی CRM تنها ردیف‌های دارای رضایت معتبر، کانال مجاز و ظرفیت تماس باقی‌مانده را شامل می‌شود. قرارداد کامل در `docs/contact-safety-contract-fa.md` آمده است.
